...
public class PercolationVisualizer {
    ...
    public static void draw(Percolation PercolationVisualizer, int n) {
        StdDraw.clear();
        ...
        StdDraw.text(0.25 * n, -0.025 * n,
                     PercolationVisualizer.numberOfOpenSites() + " open sites");
        if (PercolationVisualizer.percolates()) StdDraw.text(0.75 * n, -0.025 * n, "percolates");
